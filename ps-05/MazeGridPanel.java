...
public class MazeGridPanel extends JPanel{
	...
	public void solveMaze() {
		...
		// Cell curLocation = maze[rows-1][0];
		// System.out.println(curLocation.row);
		// System.out.println(curLocation.col);
		// System.out.println(curLocation.northWall);
		// System.out.println(curLocation.southWall);
		// System.out.println(curLocation.eastWall);
		// System.out.println(curLocation.westWall);
		while (!stack.isEmpty()){
